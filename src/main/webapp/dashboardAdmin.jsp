         ...
         <div class="container d-flex justify-content-center m-8">
             ...
             <div class="row">
                  <form action="searchServlet" method="get">
                   <input type="text" name="q" class="col-10 border-solid border border-gray-800 p-2 outline-none" placeholder="Entrer le numéro du mois à chercher" />
                   <span><button type="submit" class="col p-2" ><i class="bi bi-search"></i></button></span>
                </form>
             </div>
             </div>        
